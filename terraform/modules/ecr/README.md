...
**Inputs:** `repository_names` (`list(string)`, default `["railhead-app"]` as a module-level placeholder; the dev environment overrides this to the two real services, `["railhead-api", "railhead-worker"]`).
